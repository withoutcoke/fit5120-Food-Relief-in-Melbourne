										...
										if ($type == 'marker') {
											...
											if (count($query_result) >= 1) {
												...
												if ($format == 'json') {
													...
													echo '<data>'.PHP_EOL;
														...
														echo '<' . $remap_markername . '><![CDATA[' . stripslashes(esc_js(wp_kses($query_result['markername'], $allowedtags))) . ']]></' . $remap_markername . '>'.PHP_EOL;
														...
														echo '<' . $remap_openpopup . '>' . wp_kses($query_result['openpopup'], $allowedtags) . '</' . $remap_openpopup . '>'.PHP_EOL;
														...
														echo '<' . $remap_address . '><![CDATA[' . wp_kses($address, $allowedtags) . ']]></' . $remap_address . '>'.PHP_EOL;
													echo '</data>'.PHP_EOL;
													echo '</mapsmarker>';
											...
											if (count($query_result) >= 1) {
												if ($format == 'json') {
													...
													echo '<data>'.PHP_EOL;
														echo '<' . $remap_id . '>' . $query_result['id'] . '</' . $remap_id . '>'.PHP_EOL;
														echo '<' . $remap_name . '><![CDATA[' . stripslashes(wp_kses($query_result['name'], $allowedtags)) . ']]></' . $remap_name . '>'.PHP_EOL;
														echo '<' . $remap_basemap . '>'.$query_result['basemap'] . '</' . $remap_basemap . '>'.PHP_EOL;
														...
														echo '<' . $remap_address . '>' . wp_kses($query_result['address'], $allowedtags) . '</' . $remap_address . '>'.PHP_EOL;
													echo '</data>'.PHP_EOL;
													echo '</mapsmarker>';
								...
								******************************/
									...
									if ( $lmm_options['api_permissions_add'] == TRUE ) {
										if ($type == 'marker') {
											...
											$basemap = isset($_POST['basemap']) && in_array($_POST['basemap'], array('osm_mapnik','stamen_terrain','stamen_toner','stamen_watercolor','googleLayer_roadmap','googleLayer_satellite','googleLayer_hybrid','googleLayer_terrain','bingaerial','bingaerialwithlabels','bingroad','ogdwien_basemap','ogdwien_satellite','mapbox','mapbox2','mapbox3','custom_basemap','custom_basemap2','custom_basemap3','empty_basemap')) ? $_POST['basemap'] : (isset($_GET['basemap']) && in_array($_GET['basemap'], array('osm_mapnik','stamen_terrain','stamen_toner','stamen_watercolor','googleLayer_roadmap','googleLayer_satellite','googleLayer_hybrid','googleLayer_terrain','bingaerial','bingaerialwithlabels','bingroad','ogdwien_basemap','ogdwien_satellite','mapbox','mapbox2','mapbox3','custom_basemap','custom_basemap2','custom_basemap3','empty_basemap')) ? $_GET['basemap'] : $lmm_options[ 'standard_basemap' ]);
											...
											if ($result_add == TRUE) {
												if ($format == 'json') {
													...
													echo '<data>'.PHP_EOL;
														...
														echo '<' . $remap_markername . '><![CDATA[' . stripslashes(wp_kses($markername_quotes, $allowedtags)) . ']]></' . $remap_markername . '>'.PHP_EOL;
														...
														echo '<' . $remap_popuptext . '><![CDATA[' . stripslashes(wp_kses($popuptext, $allowedtags)) . ']]></' . $remap_popuptext . '>'.PHP_EOL;
											...
											if ($result_add == TRUE) {
												if ($format == 'json') {
													...
													echo '<data>'.PHP_EOL;
														echo '<' . $remap_id . '>' . $wpdb->insert_id . '</' . $remap_id . '>'.PHP_EOL;
														echo '<' . $remap_name . '><![CDATA[' . stripslashes(wp_kses($name_quotes, $allowedtags)) . ']]></' . $remap_name . '>'.PHP_EOL;
														echo '<' . $remap_basemap . '>' . $basemap . '</' . $remap_basemap . '>'.PHP_EOL;
														...
														echo '<' . $remap_address . '>' . $address . '</' . wp_kses($remap_address, $allowedtags) . '>'.PHP_EOL;
													echo '</data>'.PHP_EOL;
													echo '</mapsmarker>';
