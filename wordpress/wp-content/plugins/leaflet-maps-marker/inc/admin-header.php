...
if ( ($action == 'add') || ($action == 'edit') || ($action == 'duplicate') ) {
	...
	*/
	...
	?>
	<div style="font-size:1.5em;margin-top:7px;"><span style="font-weight:bold;">Leaflet Maps Marker<sup style="font-size:75%;">&reg;</sup> v<?php echo $free_version['Version']; ?> (<a href="https://www.mapsmarker.com/v<?php echo $free_version['Version']; ?>" target="_blank" title="<?php esc_attr_e('view retirement info & coupon code for Maps Marker Pro upgrade','lmm');?>">retired</a>)</span></div>
