    ...
    protected function _register_controls() {
        ...
        $this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'(desktop){{WRAPPER}} .bdt-direction-svg' => 'transform: rotate({{direction_rotate.SIZE || 0}}deg);',
					'(tablet){{WRAPPER}} .bdt-direction-svg' => 'transform: rotate({{direction_rotate_tablet.SIZE || 0}}deg);',
					'(mobile){{WRAPPER}} .bdt-direction-svg' => 'transform: rotate({{direction_rotate_mobile.SIZE || 0}}deg);',
                ],
                'condition'   => [
                    'direction_offset_toggle' => 'yes'
                ],
