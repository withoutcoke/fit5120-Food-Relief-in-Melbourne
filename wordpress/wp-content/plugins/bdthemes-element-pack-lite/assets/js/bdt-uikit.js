        ...
        events: [
...

            {
                ...
                handler: function(_, ref) {
                    ...
                    toggleClass(this.dropbar, 'bdt-navbar-dropbar-slide', this.dropbarMode === 'slide' || parents(this.$el).some(function (el) { return css(el, 'position') !== 'static'; }));
